...
{
    public Text scoreTextPlayer1; // Reference to the Text component
    private int currentScore = 0; // Variable to keep track of the current score

    // Start is called before the first frame update
    void Start()
    {
        scoreTextPlayer1.text = "Player 1: " + currentScore.ToString(); // Initialize the text
    }
    ...
    public void UpdateScore(int newScore)
    {
        ...
        scoreTextPlayer1.text = "Player 1: " + currentScore.ToString(); // Update the score text
